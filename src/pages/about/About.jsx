...
import { AboutContainer, AboutContent, AboutImage, AboutText, AboutTextContainer, AboutTextTitle } from "./about.styles"
...
const About = () => {
    ...
    return (
        <AboutContainer style={{background: darkmode ? '#252525' : '#EEEEEE'}}>
            <PageHeader path={'/'}/>
            <AboutContent style={{background: darkmode ? '#252525' : '#EEEEEE'}}>
                <AboutTextContainer style={{background: darkmode ? 'rgb(49, 49, 49)' : '#AAA'}}>
                    <AboutTextTitle style={{color: darkmode ? 'rgb(204, 204, 204)' : 'rgb(10, 10, 10)'}}>ABOUT US</AboutTextTitle>
                    <AboutText style={{color: darkmode ? 'rgb(204, 204, 204)' : 'rgb(10, 10, 10)'}}>{text}</AboutText>
                </AboutTextContainer>
